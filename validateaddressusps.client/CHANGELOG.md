...
- Create Angular project with ng: `ng new validateaddressusps.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`validateaddressusps.client.esproj`).
